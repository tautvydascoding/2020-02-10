...
//     document.querrySelector('#reklama').innerHTML += "Naujiena 30%";
// });
// console.log(y);// !!!! error nes y nepasiekiamas, Local
// console.log(x); //20
//
//
// jQuery(function( $ ) {
...
$( "h1" ).css("background", "black").add( "h2" ).css( "background", "yellow" );

// // paveiks paskutini is li elementu
$( "li" ).last().css( "background", "yellow" );
$( "li:last" ).addClass( "selected highlight" );

$( "p:even" ).css('background-color', "#f2f2f2"); //nudazo kas antra elementa lygini, odd-nelyginis
// //$( "p:eq(1)" ); // pirmas
...
//ieskom inpu kurio tipas yra email ir uzpildome
//ivedimo lauka su komanda 'val'
