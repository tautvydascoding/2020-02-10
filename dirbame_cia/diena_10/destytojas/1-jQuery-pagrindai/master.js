...
// ieskom input , kurio tipas yra email
// uzpildome ivedimo lauka su komanda 'val'

// note: $("input[type='email']").attr('value') // will return value from DOM/HTML.
// html
<input type="email" name='vardas' value="" destytojas="tautvydas">
