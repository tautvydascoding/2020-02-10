...
<html>
    ...
    <body>
        ...
        <article    skaicius='8'>
            <div class='zinute'> Zinia </div>
            <button class='btn-istrinti' >Istrinti 8 gydytoja</button>
        </article>

        <article    skaicius='9'>
            <div class='zinute'> Zinia </div>
            <button class='btn-istrinti' >Istrinti 9 gydytoja</button>
        </article>

        <article    skaicius='10'>
            <div class='zinute'> Zinia </div>
            <button class='btn-istrinti' >Istrinti 10 gydytoja</button>
        </article>

        <article    skaicius='12'>
            <div class='zinute'> Zinia </div>
            <button class='btn-istrinti' >Istrinti 12 gydytoja</button>
        </article>
