...
for (var i = 0; i < 40; i++) {
  console.log("Azuolas");
  document.querySelector("article").innerHTML += " Azuolas";
}
...
for (var i = 0; i < 10; i++) {
  ...
  document.querySelector("header").innerHTML += " <p> Aprasymas "+i+" </p> " +i;
}
// 1.5 UZDUOTIS
...
printx(" funkcijaxx ");
document.querySelector("body").innerHTML += " funkcijaxx";
// 2.2 UZDUOTIS
