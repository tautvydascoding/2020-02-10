...
// for( i = 0; i < 12; i++) {
// printX('<img src="img.jpg">');
// }

// 4 UZDUOTIS
// A) sukurti f-jas piestiEilute(x); spausdintiStulpeli(x);
// B) nupiesti tuscia lentele paleidiznat f-jas
//(  antrastine eilute "vardas |  pavarde | amzius" - teks isvesti be f-jos)
...
function spausdintiStulpeli(x) {
  document.querySelector('body').innerHTML += '</br>' + x;
}
spausdintiStulpeli("/");
