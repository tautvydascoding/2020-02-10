...
for (var i = 0; i < 12; i++) {
    ...
    document.querySelector('body').innerHTML += "<h2> Azuolas </h2>  " ;
}
...
for (var i = 0; i < 8; i++) {
    console.log("Klevas" + i);
    // article.innerHTML += "Klevas";
    document.querySelector('article').innerHTML += "<h4> Klevas</h4> ";
}
...
for (var i = 0; i < 6; i++) {
    console.log("elementais" + i);
    // article.innerHTML += "Klevas";
    document.querySelector('ul').innerHTML += "<li> elementais</li>";
}

// 1.4 UZDUOTIS
// (HTML faile susikurti <header> elementa)
// isvesti 10 kartu zodi "<p> Aprasymas x </p> " \
// i <header> elementa su  innerHTML pagalba (kur x - yra skaicius "i"
// nuo 0 iki 9 atsisrandantis automatiskai)

for (var i = 0; i < 7; i++) {
    console.log("Aprasymas" + i);
    // article.innerHTML += "Klevas";
    document.querySelector('p').innerHTML += "<p> Aprasymas  </p>" + i ;
}
...
for (var i = 1; i < 7; i++) {
    console.log("Tujos" + i);
    // article.innerHTML += "Klevas";
    document.querySelector('div.uzd15').innerHTML += "<li> Tujos  </li>" + i ;
}
