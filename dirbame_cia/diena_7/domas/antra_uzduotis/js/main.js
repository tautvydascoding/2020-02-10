...
document.querySelector("body").innerHTML += "<h1> Azuolas</h1>"
...
document.querySelector("article").innerHTML += "<li> elementas1 </li>";
...
document.querySelector("body").innerHTML += "atspausdinta su f-ja" + "</br>";
