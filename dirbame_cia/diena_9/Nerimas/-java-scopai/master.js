...
// // function test2() {
// //     var katinas = "baltas";
// //     console.log = "1 katinas"; // Local'
// //     console.log = "2 this.katinas - f-jos viduje"; // Local'
// //     console.log = "2 window.katinas = f=jos viduje"; // Local'
// }
// test2();
// ====================Scope====================
//   UZDUOTIS  A
...
function printAntraste(x) {
    ...
    printAntraste("<h2>Antraste</h2>");
    printAntraste("<p>Lorem...</p>");
...
function printAntraste(x) {
    ...
    printAntraste("<h2>Antraste</h2>");
    printAntraste("<p>Lorem...</p>");
    printAntraste("<h3>labukas</h3>");
    printAntraste("<article>asdasd");
    printAntraste("<article>xcvxcv");
    printAntraste("<article>asdasdsadasdsad</article>");
